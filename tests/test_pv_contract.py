...
def test_chiller_pv_contract():
    ...
    expected = {
        ...
        "BDX:CHILLER:CHILLER1:SAFE_SETPOINT_SET",
        "BDX:CHILLER:CHILLER1:SAFE_SETPOINT_RBV",
        "BDX:CHILLER:CHILLER1:COMM_TIMEOUT_SET",
